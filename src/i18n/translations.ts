...
const translations: Record<Locale, TranslationStrings> = {
  ...
  kl: {
    ...
    cookieLocale: 'oqaatsit - Oqaatsit atussallugit toqqakkatit',
    cookieTheme: 'app-ip qaamassusaa - Qaamassuseq illit toqqakkat',
  ...
  da: {
    ...
    cookieLocale: 'locale - Dit valgte sprog',
    cookieTheme: 'theme - Dit valgte tema',
  ...
  en: {
    ...
    cookieLocale: 'locale - Your selected language',
    cookieTheme: 'theme - Your selected theme',
